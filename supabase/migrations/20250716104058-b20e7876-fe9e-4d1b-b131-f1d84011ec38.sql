...
('Família Costa', 'Ana Costa', '(11) 76543-2109', 5, true, '2025-01-20 00:00:00', 'Recebeu cesta básica'),
('Família Pereira', 'Carlos Pereira', '(11) 65432-1098', 2, true, '2025-01-10 00:00:00', 'Recebeu cesta básica'),
...
INSERT INTO public.deliveries (family_id, institution_id, delivery_date, blocking_period_days, notes)
SELECT f.id, i.id, '2024-12-15 10:00:00', 30, 'Entrega de dezembro'
FROM public.families f, public.institutions i
WHERE f.name = 'Família Pereira' AND i.name = 'Instituto Esperança'
UNION ALL
SELECT f.id, i.id, '2024-12-20 15:00:00', 30, 'Entrega natalina'
FROM public.families f, public.institutions i
WHERE f.name = 'Família Costa' AND i.name = 'Centro Social São Vicente';

-- Entregas recentes normais
INSERT INTO public.deliveries (family_id, institution_id, delivery_date, blocking_period_days, notes)
SELECT f.id, i.id, '2025-01-14 10:00:00', 30, 'Entrega regular'
FROM public.families f, public.institutions i
WHERE f.name = 'Família Oliveira' AND i.name = 'Associação Comunitária Esperança'
UNION ALL
SELECT f.id, i.id, '2025-01-11 14:00:00', 30, 'Entrega mensal'
FROM public.families f, public.institutions i
...
INSERT INTO public.deliveries (family_id, institution_id, delivery_date, blocking_period_days, notes)
SELECT f.id, i.id, '2025-01-13 09:00:00', 15, 'Entrega express'
FROM public.families f, public.institutions i
WHERE f.name = 'Família Silva' AND i.name = 'Associação Comunitária Esperança'
UNION ALL
SELECT f.id, i.id, '2025-01-14 11:00:00', 15, 'Segunda entrega'
FROM public.families f, public.institutions i
WHERE f.name = 'Família Oliveira' AND i.name = 'Associação Comunitária Esperança'
UNION ALL
SELECT f.id, i.id, '2025-01-15 13:00:00', 15, 'Terceira entrega'
FROM public.families f, public.institutions i
WHERE f.name = 'Família Santos' AND i.name = 'Associação Comunitária Esperança';