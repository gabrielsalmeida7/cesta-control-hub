-- Passo 3: Inserir Dados de Teste no Banco

-- Primeiro, criar uma instituição teste para vincular o usuário institution
...
-- Inserir profiles para os usuários bypass
INSERT INTO public.profiles (id, email, full_name, role, institution_id, created_at, updated_at)
VALUES 
  (
    'd1e6f7a2-b3c4-5d6e-7f8a-9b0c1d2e3f40',
...
INSERT INTO public.families (id, name, contact_person, phone, members_count, is_blocked, created_at, updated_at)
VALUES 
  (
